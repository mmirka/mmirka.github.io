...
Chapter 5 generated the *shape* of a network. This chapter fixes it (i.e. an 8×8
...
simulation (here, OMNeT++ with the HNOCS framework, extended with synthetic traffic
...
activation that forces each router's 3-vector to be one-hot , i.e. exactly one class
