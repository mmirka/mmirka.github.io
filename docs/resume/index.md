...
Data Scientist with a PhD in Artificial Intelligence and over six years of
combined research and industry experience, specialized in machine learning,
deep learning and applied AI. Experienced in leading multidisciplinary teams
and delivering AI solutions for telecommunication network optimization.

## Key achievements

- Founded and led the AI and Data Science R&D division at ITSF / NJJ Holding,
  delivering AI-driven network optimization solutions for telecommunications.
- Designed and deployed LLM- and RAG-based prototypes for knowledge management
...
- Built the research unit from scratch: research priorities, methodology, and
  collaboration between IT developers and network engineers.
- Applied machine learning and deep learning to mobile network performance,
  reducing inefficiencies and enabling predictive maintenance.
- Designed validation and monitoring frameworks so AI solutions were safe,
  reliable and production-ready.
- Mentored an intern and an MSc apprentice (M2), aligning their research with
  both industrial and pedagogic goals.

Projects:

- Internal RAG based on a Large Language Model and a Knowledge Graph, for
  knowledge management and operational support.
- Time series forecasting for anomaly detection and network demand prediction.
- Network Intelligence on cloud services: data science use cases implemented on
  cloud platforms, Airflow DAGs for pipeline orchestration, and Superset
  dashboards for presenting results.
- Pattern mining on large-scale telecom data for strategic analysis and
  prediction.
- Multi-class classification for automatic labelling.
- Historical data analysis for energy saving.
...
- Worked in an interdisciplinary lab combining computer science, control theory
...
- **Deep reinforcement learning for energy efficiency.** An energy-efficiency
  metric relying on the OpenMP framework; an autoencoder and reinforcement
  learning for workload classification and resource allocation.
  [Project page](../projects/omp-energy-rl.md) ·
  [repository](https://github.com/mmirka/omp-energy-rl).
- **Generative AI for computer-assisted NoC design.** A new GAN architecture to
  guide and accelerate design space exploration.
  [GANNoC](../projects/gannoc.md)
  ([repository](https://github.com/mmirka/GANNoC)) and
  [M-RWGAN](../projects/m-rwgan.md)
...
by dragonfly locomotion.

Technical stack: Matlab, Solidworks.
...
Lectures and tutorials at master's level, in French
engineering schools, on machine learning, distributed applications and networks.
The [teaching page](../teaching/index.md) lists the subjects and topics covered.

Hours below are per school, as recorded in my French teaching CV. No total is
given: my English CVs state "128+ hours" and attach it to the doctoral period at
Montpellier, while the lines below run from 2018 to 2026 and sum to more.

| School | Years | Subjects | Hours | Level |
|---|---|---|---|---|
| ESME Lyon | 2026 | Machine Learning | 12 h | Engineering, year 3 |
| CPE Lyon | 2024 – 2025 | Machine Learning | 34 h | Engineering, year 4 |
| Polytech Montpellier | 2018 – 2024 | Distributed applications, Networks, Machine Learning | 140 h | Engineering, years 3 and 4 |

## Publications

Four international conference papers and one poster on machine learning and distributed
systems, including at DATE, all open access on HAL. The
...
Astrophysics, drumming, photography. Sport: fitness, climbing, hiking.
